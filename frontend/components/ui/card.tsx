...
const Card: React.FC<CardProps> = ({
  ...
  return (
    <div className="max-w-xs bg-blackCustom border border-brown border-2 shadow dark:bg-gray-800 dark:border-yellow-700 p-3">
      <div>
        {isPrivate == true && (
          <span className="text-brownText px-2 py-1 bg-brown flex w-fit">
            <svg
              className="w-6 h-6 text-brownText dark:text-whiteCustom"
              aria-hidden="true"
      ...
      <Link href={href} passHref className="text-center">
        <h5 className="my-3 text-2xl font-bold tracking-tight text-brownText dark:text-whiteCustom">
          {title}
        </h5>
      </Link>
      <div>
