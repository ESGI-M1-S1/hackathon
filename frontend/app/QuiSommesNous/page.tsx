  ...
  return (
    <section className="bg-cover bg-no-repeat bg-[url('/QuiSommesNousBandeau.jpg')] bg-gray-700 bg-blend-multiply">
      <div className="flex flex-col items-center gap-8 px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-12">
        <h1 className="mb-4 text-4xl leading-none text-whiteCustom md:text-5xl lg:text-6xl">
          Qui Sommes Nous
        </h1>
      </div>
    </section>
    ...
    <section className="py-12">
      <div className="flex flex-col items-center gap-4 max-w-screen-xl px-4 mx-auto">
        ...
        <p className="max-w-1xl text-center">
          ...
          scelerisque, tortor eget ornare aliquet, justo ligula ultrices turpis,
          vel cursus nunc eros nec ex. Donec in neque eget nisl tincidunt
          tincidunt.
        </p>
      </div>
    </section>
    ...
    <section className="">
      <div className="flex flex-col items-center gap-4 max-w-screen-xl px-4 mx-auto">
        ...
        <p className="max-w-1xl text-center">
          ...
          scelerisque, tortor eget ornare aliquet, justo ligula ultrices turpis,
          vel cursus nunc eros nec ex. Donec in neque eget nisl tincidunt
          tincidunt. Justo ligula ultrices turpis, vel cursus nunc eros nec ex.
          Donec in neque eget nisl tincidunt tincidunt.
        </p>
      </div>
    </section>
  );
